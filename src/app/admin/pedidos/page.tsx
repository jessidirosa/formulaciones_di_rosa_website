...
export default async function PedidosPage({ searchParams }: PedidosPageProps) {
    ...
    const mesFiltro = params.mes // El mes que viene por URL
    ...
    // --- CONSTRUCCIÓN DEL FILTRO UNIFICADO ---
    const where: any = {}
    ...
    // Aplicar filtro de mes a la consulta principal si existe
    if (mesFiltro) {
    ...
    // ESTA ES LA CONSULTA QUE MANDA (Contiene todo el include necesario)
    ...
    return (
        <div className="container mx-auto px-4 py-10 space-y-8 text-left">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 w-full md:w-auto">
                    ...
                    <Card className="px-4 py-3 border-gray-100 bg-gray-50/50 shadow-sm flex flex-col justify-center min-w-[160px]">
                        ...
                        <p className="text-[8px] text-gray-400 italic">{mesFiltro ? 'Total del mes' : 'Total acumulado en filtro'}</p>
                    </Card>
                </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 bg-white p-3 rounded-xl border border-gray-100 shadow-sm w-fit overflow-x-auto max-w-full">
                ...
                <div className="flex gap-1">
                    <Link
                        ...
                        className={`text-[9px] px-3 py-1.5 rounded-lg font-bold transition-all border ${!mesFiltro
                    ...
                    {[
                        ...
                        <Link
                            ...
                            className={`text-[9px] px-2.5 py-1.5 rounded-lg font-bold transition-all border ${mesFiltro === m.n
                            ...
                            <TableBody>
                                {pedidos.map((pedido) => (
                                    <Fragment key={pedido.id}>
                                        ...
                                        {/* BLOQUE DE DETALLES: AQUÍ ESTÁ TODO LO QUE SE HABÍA PERDIDO */}
                                                ...
                                                <div className="bg-white border border-gray-200 rounded-xl p-4 shadow-sm grid grid-cols-1 md:grid-cols-3 gap-6">
                                                    ...
                                                    <div className="space-y-3 min-w-0">
                                                        ...
                                                        <div className="text-[11px] space-y-1.5 text-gray-700">
                                                            ...
                                                            <p className="truncate"><span className="text-gray-400 font-medium">Ubicación:</span> {pedido.localidad || pedido.ciudad}, {pedido.provincia}</p>

                                                            {pedido.sucursalNombre && <p className="font-bold text-[#4A5D45]">Sucursal: {pedido.sucursalNombre}</p>}
                                                            {pedido.sucursalCorreo && <p className="font-medium text-gray-600 italic">Ref. Correo: {pedido.sucursalCorreo}</p>}
