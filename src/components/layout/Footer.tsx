        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div className="col-span-1 md:col-span-2 space-y-6">
            <Link href="/" className="inline-block transition-opacity hover:opacity-80">
              <img src="/logo.png" alt="Formulaciones Di Rosa" className="h-14 w-auto brightness-0 invert" />
            </Link>
            ...
            <div className="flex space-x-5">
              <a href="https://wa.me/541137024467" target="_blank" className="text-gray-400 hover:text-[#25D366] transition-colors">
              ...
              <a href="https://www.instagram.com/formulacionesdirosa" target="_blank" className="text-gray-400 hover:text-[#E4405F] transition-colors">
