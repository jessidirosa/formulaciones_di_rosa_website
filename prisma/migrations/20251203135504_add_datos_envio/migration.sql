...
INSERT INTO "new_Pedido" ("apellidoCliente", "ciudad", "codigoPostal", "costoEnvio", "createdAt", "direccion", "dniCliente", "emailCliente", "estado", "fechaEstimadaEnvio", "id", "metodoEnvio", "nombreCliente", "notasCliente", "numero", "provincia", "subtotal", "sucursalCorreo", "telefonoCliente", "tipoEntrega", "total", "userId") SELECT "apellidoCliente", "ciudad", "codigoPostal", "costoEnvio", "createdAt", "direccion", "dniCliente", "emailCliente", "estado", "fechaEstimadaEnvio", "id", "metodoEnvio", "nombreCliente", "notasCliente", "numero", "provincia", "subtotal", "sucursalCorreo", "telefonoCliente", "tipoEntrega", "total", "userId" FROM "Pedido";
DROP TABLE "Pedido";
